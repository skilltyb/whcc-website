...
# insert ~200 rows of synthetic demo registrations into real data. The
# 'clear-test' action below is also no longer implemented in the current
# Code.gs, so it will now no-op rather than actually clear anything.
